...
class DistantSupervisionAnalyzer(object):
    ...
    resultsDirectory = os.path.join(packageDirectory, "../../../results/distantLearningSubjectIdentificationSupportConnectivity")
    ...
    def getResult(self, support, connectivity):
        ...
        precision = float(precision) / len(range(1,11))
